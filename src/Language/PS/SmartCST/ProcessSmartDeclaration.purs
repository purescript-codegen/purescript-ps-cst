...
processExpr (SmartCST.Declaration.ExprOp exprA opName exprB)     = CST.Declaration.ExprOp <$> processExpr exprA <*> processSmartQualifiedNameOp opName <*> processExpr exprB
