...
import Language.PS.CST.Printers (exprShouldBeOnNextLine, printBinder, printComments, printDeclaration, printDeclarations, printExpr, printGuarded, printInstanceBinding, printLetBinding, printMaybeComments, printModule, printModuleToString, printRecordLabeled, printRecordUpdate, printRecordUpdates, printValueBindingFields) as Export
